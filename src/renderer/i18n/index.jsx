...
const S = {
  ...
  'friends.addPlaceholder': ['Nick do amigo...', 'Nick do amigo...'],
  'friends.addBtn': ['Adicionar', 'Adicionar'],
  'friends.tabFriends': ['Amigos', 'Amigos'],
  'friends.tabRequests': ['Solicitações', 'Pedidos'],
  'friends.tabBlocked': ['Bloqueados', 'Bloqueados'],
  'friends.requestsIn': ['Recebidas', 'Recebidas'],
  'friends.requestsOut': ['Enviadas', 'Enviadas'],
  'friends.emptyFriends': [
    'Nenhum amigo ainda. Adicione alguém pelo nick acima!',
    'Ainda sem amigos. Adicione alguém pelo nick acima!',
  ],
  'friends.emptyRequests': ['Nenhuma solicitação pendente.', 'Nenhum pedido pendente.'],
  'friends.emptyBlocked': ['Nenhum usuário bloqueado.', 'Nenhum utilizador bloqueado.'],
  'friends.message': ['Mensagem', 'Mensagem'],
  'friends.block': ['Bloquear', 'Bloquear'],
  'friends.unblock': ['Desbloquear', 'Desbloquear'],
  'friends.accept': ['Aceitar', 'Aceitar'],
  'friends.decline': ['Recusar', 'Recusar'],
  'friends.cancel': ['Cancelar', 'Cancelar'],
  'friends.online': ['online', 'online'],
  'friends.offline': ['offline', 'offline'],
  'friends.blockedTag': ['bloqueado', 'bloqueado'],
  'friends.chatWith': ['Conversando com {nick}', 'A conversar com {nick}'],
  'friends.chatEmpty': ['Sem mensagens ainda. Diga oi!', 'Ainda sem mensagens. Diz olá!'],
  'friends.chatPlaceholder': ['Escreva uma mensagem...', 'Escreve uma mensagem...'],
  'friends.chatSend': ['Enviar', 'Enviar'],
  'friends.chatOffline': [
    'Amigo offline — a mensagem será entregue quando ele voltar.',
    'Amigo offline — a mensagem será entregue quando ele voltar.',
  ],
  'friends.blockConfirm': [
    'Bloquear {nick}? Vocês não poderão trocar mensagens.',
    'Bloquear {nick}? Não poderão trocar mensagens.',
  ],
  'friends.unavailable': [
    'Amigos indisponíveis: backend de contas não configurado.',
    'Amigos indisponíveis: backend de contas não configurado.',
  ],
  'friends.reqSent': ['Solicitação enviada para {nick}!', 'Pedido enviado para {nick}!'],
  'friends.reqAccepted': ['Você e {nick} agora são amigos!', 'Tu e {nick} agora são amigos!'],
  'friends.reqDeclined': ['Solicitação de {nick} recusada.', 'Pedido de {nick} recusado.'],
  'friends.reqCancelled': ['Solicitação cancelada.', 'Pedido cancelado.'],
  'friends.unblocked': ['{nick} desbloqueado.', '{nick} desbloqueado.'],
  'friends.newRequest': ['{nick} quer ser seu amigo!', '{nick} quer ser teu amigo!'],
  'friends.newMessage': ['Nova mensagem de {nick}', 'Nova mensagem de {nick}'],
  'friends.errNickNotFound': ['Nick não encontrado.', 'Nick não encontrado.'],
  'friends.errSelf': ['Você não pode se adicionar.', 'Não te podes adicionar.'],
  'friends.errInvalidNick': ['Nick inválido (3–16: letras, números ou _).', 'Nick inválido (3–16: letras, números ou _).'],
  'friends.errAlready': ['Vocês já são amigos.', 'Já são amigos.'],
  'friends.errPendingOut': ['Você já enviou solicitação para {nick}.', 'Já enviaste pedido para {nick}.'],
  'friends.errPendingIn': ['{nick} já te enviou uma solicitação — aceite na aba Solicitações.', '{nick} já te enviou um pedido — aceita no separador Pedidos.'],
  'friends.errBlockedMe': ['Desbloqueie {nick} antes de adicionar.', 'Desbloqueia {nick} antes de adicionar.'],
  'friends.errBlockedThem': ['Não foi possível enviar a solicitação.', 'Não foi possível enviar o pedido.'],
  'friends.errBlockedSend': ['Não foi possível enviar. Você foi bloqueado por este usuário.', 'Não foi possível enviar. Foste bloqueado por este utilizador.'],
  'friends.errNotFriends': ['Vocês não são mais amigos.', 'Já não são amigos.'],
  'friends.errGeneric': ['Algo deu errado. Tente de novo.', 'Algo correu mal. Tenta de novo.'],
  'friends.errToken': ['Sessão expirada. Saia e entre de novo.', 'Sessão expirada. Sai e entra de novo.'],
